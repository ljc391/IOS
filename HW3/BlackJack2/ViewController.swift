...
class ViewController: UIViewController, UITextFieldDelegate, UIActionSheetDelegate {
    ...
    func showOptions() {
        if CurrentTextField.tag == 1 {
            let actionSheet = UIActionSheet(title: "Choose How Many Players, 1 with AI Player", delegate: self, cancelButtonTitle: "Cancel", destructiveButtonTitle: nil, otherButtonTitles: "1", "2", "3", "4", "5")
